...
export async function geojsonEnricherV2(
  ...
  try {
    console.log('🚀 Starting enhanced GeoJSON enrichment...');
    console.log('📝 Input text:', researcherResponse.substring(0, 200) + '...');
    ...
    if (jsonMatch && jsonMatch[2]) {
      ...
      console.log('✂️ Stripped markdown fences');
    }

    const enrichedData = JSON.parse(responseText) as LocationResponse;
    
    console.log('✅ Enhanced GeoJSON enrichment complete:', {
    ...
    console.error('❌ Enhanced GeoJSON enrichment error:', error);
