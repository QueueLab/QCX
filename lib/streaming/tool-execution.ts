...
export async function executeToolCall(
  ...
  const toolSelectionResponse = await generateText({
    ...
    system: `You are an intelligent assistant that analyzes conversations to sel
ect the most appropriate tools and their parameters.
            You excel at understanding context to determine when and how to use
available tools, including crafting effective search queries.
            ...
            <tool_call>
              ...
              <parameters>
                ...
                <max_results>number - ${defaultMaxResults} by default</max_resul
ts>
            ...
            If you don't need a tool, respond with <tool_call><tool></tool></too
l_call>`,
