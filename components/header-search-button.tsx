...
export function HeaderSearchButton() {
  ...
  const mobileButton = (
    <Button variant="ghost" size="icon" onClick={handleResolutionSearch} disabled={isAnalyzing || !actions} data-testid="mobile-search-button">
      {isAnalyzing ? (
